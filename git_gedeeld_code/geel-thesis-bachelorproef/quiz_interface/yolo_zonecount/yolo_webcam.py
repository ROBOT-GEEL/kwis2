...
camera_settings = {
    "A": {
       ...
       # "polygon": [(1000, 0), (1000, 2160), (3000, 2160), (3000, 0)],
        "polygon":[(106, 1018), (47, 9), (809, 23), (730, 1014)],
    },
    "B": {
        ...
        "polygon":[(736, 1019), (784, 25), (1340, 14), (1334, 1018)],
    },
    "C": {
        ...
        "height": 2160,
        #"polygon": [(1000, 0), (1000, 2160), (3000, 2160), (3000, 0)],
        "polygon": [(1253, 1033), (1234, 52), (1844, 30), (1819, 1029)],
    }
}
...
for zone, settings in camera_settings.items():
    ...
    polygon_zone = sv.PolygonZone(polygon=polygon, frame_resolution_wh=(settings["width"], settings["height"]))
...
def count_people(timestamp):
    ...
    for zone, values in camera_settings.items():
        ...
        #frame = sv.draw_polygon(scene=frame, polygon=values["polygon"], color=Color.RED, thickness=6)
        ...
        cv.imwrite(f'result_{zone}_{datetime.now()}.jpg', frame)
